 ...
 * <p>
 * This event contains information about the player who triggered the enchant,
 * the WorldGuard region where it happened, the original block broken,
 * and the list of blocks affected by the enchantment.
 * <p>
 * The event is cancellable, allowing listeners to prevent the enchant effect from occurring.
 */
@Getter
public final class LayerTriggerEvent extends XPrisonPlayerEnchantTriggerEvent implements Cancellable {
	...
	/**
	 * Constructs a new {@code LayerTriggerEvent}.
	 *
	 ...
	 * @param blocks      The list of affected blocks marked for removal.
	 */
